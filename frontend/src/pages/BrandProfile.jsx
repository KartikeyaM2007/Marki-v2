  ...
  return (
    <div className="bp-page">
      <div className="bp-header">
        ...
        <p className="bp-subtitle">Tell Marki everything about your brand — the more you share, the better your content.</p>
      </div>
...
<Section icon="🔗" title="Connected Accounts">
  <Field label="Connect your social platforms" hint="Link your accounts so Marki can schedule and publish posts directly.">
    <div className="bp-connect-group">
      ...
      <div className="bp-connect-card">
        ...
        <div className="bp-submit-row">
          ...
          <p className="bp-submit-hint">Your profile is used by Marki AI to generate content that sounds exactly like you.</p>
        </div>

...
const floatingPosts = [
  {
    ...
    name: "Sarah K.",
    time: "2h ago",
    content: "Just launched our Q3 campaign using Marki — 3x engagement in one week! 🚀",
    likes: 284,
    comments: 47,
    delay: "0s",
    x: "5%",
  ...
  },
  {
    ...
    name: "devmark_x",
    time: "45m ago",
    content: "Marki auto-scheduled our entire month of content while I was on vacation. Wild. 🌴",
    likes: 1200,
    comments: 89,
    delay: "0.4s",
    x: "55%",
  ...
  },
  {
    ...
    name: "designwithlu",
    time: "1d ago",
    content: "Our brand voice is CONSISTENT now. Thank you Marki for finally solving this 🙌✨",
    likes: 3490,
    comments: 203,
    delay: "0.8s",
    x: "20%",
  ...
  },
  {
    ...
    name: "startupwins",
    time: "30m ago",
    content: "Marki's RAG memory means every post sounds exactly like us. Not generic AI fluff.",
    likes: 876,
    comments: 44,
    delay: "1.6s",
    x: "38%",
...
const features = [
  { icon: "", title: "Brand Memory", desc: "Upload your docs, pitch decks, blogs — Marki learns your voice and never forgets it." },
  { icon: "", title: "One Idea → 3 Platforms", desc: "From LinkedIn stories to X threads to Instagram captions, all from a single prompt." },
  { icon: "", title: "Smart Scheduling", desc: "Set your cadence once. Marki generates and queues weeks of content automatically." },
  { icon: "", title: "Self-Improving AI", desc: "Every like and comment teaches Marki what works. Your content gets smarter over time." },
];

// Read user synchronously so it's available on first render — no flicker
const getStoredUser = () => {
  try {
    const stored = localStorage.getItem("marki_user");
    ...
    <div className="home">
      ...
      <section className="hero" ref={heroRef} id="home">
        ...
        <div className="hero__left">
          ...
          <p className="hero__sub animate-in" style={{ animationDelay: "0.2s" }}>
            Marki learns your brand, generates platform-perfect content, schedules it automatically,
        ...
        <div className="hero__right">
          <div className="posts-field">
            ...
            <div className="mascot">
              ...
              <div className="mascot__label">Marki AI</div>
            </div>
      ...
      <section className="features" id="about">
        <div className="features__header animate-in">
          ...
          <p>Marki is a self-improving AI agent, not just another scheduling tool.</p>
        </div>
      ...
      <section className="cta-banner animate-in" id="contact">
        <div className="cta-banner__content">
          ...
          <p>Join thousands of brands that let Marki do the heavy lifting.</p>
      ...
      <footer className="footer">
        <span className="footer__logo">✦ Marki</span>
        <span className="footer__copy">© 2026 Marki. All rights reserved.</span>
      </footer>
    </div>
  );
};
